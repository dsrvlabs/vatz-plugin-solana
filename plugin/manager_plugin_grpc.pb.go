...
type ManagerPluginClient interface {
	Init(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PluginInfo, error)
...
func (c *managerPluginClient) Init(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PluginInfo, error) {
	out := new(PluginInfo)
...
func (c *managerPluginClient) Verify(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*VerifyInfo, error) {
	out := new(VerifyInfo)
...
type ManagerPluginServer interface {
	Init(context.Context, *empty.Empty) (*PluginInfo, error)
...
func (UnimplementedManagerPluginServer) Init(context.Context, *empty.Empty) (*PluginInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Init not implemented")
}
func (UnimplementedManagerPluginServer) Verify(context.Context, *empty.Empty) (*VerifyInfo, error) {
...
func _ManagerPlugin_Init_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerPluginServer).Init(ctx, req.(*empty.Empty))
	}
...
func _ManagerPlugin_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerPluginServer).Verify(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
